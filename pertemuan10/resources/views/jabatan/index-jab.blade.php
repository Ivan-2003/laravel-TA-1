  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col-12">
                <div class="py-4">
                    <h2>Tabel Data Jabatan</h2>
                    <a href="{{ route('jabatan.create') }}" class="btn btn-danger">
                        Tambah Jabatan
                    </a>
                </div>
                    ...
                    <tbody>
                        @foreach ($data as $d)
                            <tr>
                                ...
                                <td>
                                  {{-- <a href="{{ route('jabatan.edit', $d->id) }}"><button class="btn btn-primary">EDIT</button></a> --}}
                                  <form action="{{ route('jabatan.destroy', $d->id) }}" method="post">
                                      @csrf
                                      @method('delete')
