  ...
  <div class="container" style="text-align: center">
    <form action="{{ route('karyawan.update',$karyawan->id) }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
          ...
          <input type="text" name="nik" class="form-control" id="nik" placeholder="Nik" value="{{ $karyawan->nik }}">
      </div>
      <div class="form-group">
        <label for="nama_karyawan">Nama Karyawan</label>
        <input type="text" name="nama_karyawan" class="form-control" id="nama_karyawan" placeholder="Nama Karyawan" value="{{ $karyawan->nama_karyawan }}">
      </div>
      <div class="form-group">
        <label for="alamat">Alamat</label>
        <input type="text" name="alamat" class="form-control" id="alamat" placeholder="Alamat" value="{{ $karyawan->alamat }}">
      </div>
      <div class="form-group">
        <label for="no_tlp">No Tlp</label>
        <input type="text" name="no_tlp" class="form-control" id="no_tlp" placeholder="no_tlp" value="{{ $karyawan->no_tlp }}">
      </div>
      <div class="form-group">
        <label for="divisi_id">Divisi</label>
        <select name="divisi_id" id="divisi_id">
            @foreach ($divisi as $div)
            <option value="{{$div->id}}" {{ (old('div->id') ?? "$karyawan->divisi_id == $div->id") ? 'selected': ''}}>
                {{$div->nama_divisi}}
            </option>
      ...
      <div class="form-group">
        ...
        <select name="jabatan_id" id="jabatan_id">
            ...
            <option value="{{$jab->id}}" {{ (old('jab->id') ?? "$karyawan->jabatan_id == $jab->id") ? 'selected': ''}}>
                {{$div->nama_jabatan}}
            </option>
      ...
      <div class="form-group">
        ...
        <select name="status_id" id="status_id">
            ...
            <option value="{{$sta->id}}" {{ (old('sta->id') ?? "$karyawan->status_id == $sta->id") ? 'selected': ''}}>
                {{$div->nama_status}}
            </option>
