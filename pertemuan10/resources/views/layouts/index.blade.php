        ...
        <div class="row">
            <div class="col-12">
                <div class="py-4">
                    ...
                    <a href="{{ route('karyawan.create') }}" class="btn btn-danger">
                        Tambah Karyawan
                    </a>
                </div>
                    ...
                    <tbody>
                        @foreach ($data as $d)
                            <tr>
                                ...
                                {{-- <td> --}}
                                    {{-- <img src="{{ $d->image }}" alt="GAGAL LOAD"
                                    style="width:150px">
                                </td>
                                <td>
                                    {{-- <a href="#"><button class="btn btn-primary">DETAIL</button></a> --}}
                                <td>
                                    <a href="{{ route('karyawan.edit', $d->id) }}"><button class="btn btn-primary">EDIT</button></a>
